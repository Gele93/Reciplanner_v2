    ...
    <div className='recipe-list-container'>
      ...
      {recipesPerPages[curPage] &&
        recipesPerPages[curPage].map((recipe, i) => (
          <div className='recipe' key={i} onClick={() => openModal(recipe)}>
            ...
            <div className='recipe-details'>
              ...
              <h3 className='recipe-detail'>{Math.round(recipe.calories)} kcal</h3>
            </div>
      ...
      <div className='pages'>
        <button onClick={handlePrevPageClick} type='button' className='prev-page'>← prev</button>
          {pageNumbers.map(p =>(
            <button onClick={() => handlePageNumberClick(p)} className='page-number' type='button'>{p}</button>
          ))}
